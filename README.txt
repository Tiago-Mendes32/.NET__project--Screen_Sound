...
O sistema permite:
- Registrar bandas e álbuns.
- Avaliar bandas e álbuns.
- Exibir detalhes sobre as bandas.

Além disso, utiliza a **API do ChatGPT** para gerar automaticamente um resumo sobre cada nova banda registrada, proporcionando uma experiência mais rica para o usuário.
...
Ao importar o projeto, crie uma classe chamada `ApiKey` com o seguinte conteúdo:
...
- A aplicação requer uma chave ativa para acessar os serviços da API. Obtenha sua chave no site oficial do [OpenAI](https://openai.com).
